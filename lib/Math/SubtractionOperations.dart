...
class SubtractionOperations extends StatefulWidget {
  final int grade;

  const SubtractionOperations({super.key, required this.grade});

  @override
  _SubtractionOperationsState createState() => _SubtractionOperationsState();
}

class _SubtractionOperationsState extends State<SubtractionOperations> {
  ...
  void initState() {
    super.initState();
    filteredOperations = Operations.getSubtractionOperations(widget.grade).where((op) => op["Grade"] == widget.grade).toList();
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            Navigator.push(
              ...
              //Navigator.pop(context, numbers["result"]);
            });
          },
          child: Padding(
