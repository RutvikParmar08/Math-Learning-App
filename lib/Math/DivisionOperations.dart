...
class DivisionOperations extends StatefulWidget {
  final int grade;
  const DivisionOperations({super.key, required this.grade});

  @override
  _DivisionOperationsState createState() => _DivisionOperationsState();
}

class _DivisionOperationsState extends State<DivisionOperations> {
  ...
  void initState() {
    super.initState();
    filteredOperations = Operations.getDivisionOperations(widget.grade).where((op) => op["Grade"] == widget.grade).toList();
  ...
  //   setState(() {
  //     filteredOperations = Operations.getDivisionOperations(widget.grade)
  //         .where((op) =>
  ...
  //       content: lottie.Lottie.asset("assets/Lottie/success.json", repeat: false),
  //       actions: [
